...
public class ReservaDAO {
    ...
    Transaction tx = null;
    public void novaReservaHab(Cliente cliente, Habitacao habitacao, LocalDate date){
        Session session = ssf.openSession();
    ...
    public void novaReservaSalao(Cliente cliente, SalaoFestas salaofestas, LocalDate date){
        Session session = ssf.openSession();
        tx = session.beginTransaction();
    ...
    public void alterarReserva(String nome, String local, String status, LocalDate data){
        Session session = ssf.openSession();
        Reserva r;
        tx = session.beginTransaction();
